...
final List<GameAnswer> practiceWords = [
  ...
  GameAnswer(answer: 'प्रणव', meaning: 'ओम्'),
  ...
  GameAnswer(answer: 'अतिक्रमण', meaning: 'अतिक्रमण'),
  GameAnswer(answer: 'मोहक', meaning: 'आकर्षक'),
  GameAnswer(answer: 'कुटिल', meaning: 'धूर्त'),
  GameAnswer(answer: 'गम्यता', meaning: 'पहुँच'),
  GameAnswer(answer: 'प्रतिरूप', meaning: 'प्रतिबिंब'),
  GameAnswer(answer: 'किंकर्तव्यविमूढ़', meaning: 'हक्का-बक्का'),
  GameAnswer(answer: 'धारणा', meaning: 'विचार'),
  GameAnswer(answer: 'प्रशस्ति', meaning: 'स्तुति'),
  ...
  GameAnswer(answer: 'तिरस्कार', meaning: 'अवमानना'),
  GameAnswer(answer: 'संप्रदाय', meaning: 'समुदाय'),
  ...
  GameAnswer(answer: 'प्रवृत्ति', meaning: 'प्रवृत्ति'),
  ...
  GameAnswer(answer: 'संजीवनी', meaning: 'अमृत'),
  GameAnswer(answer: 'कुंठा', meaning: 'असंतोष'),
  GameAnswer(answer: 'रुग्ण', meaning: 'बीमार'),
  GameAnswer(answer: 'फलश्रुति', meaning: 'परिणाम'),
  GameAnswer(answer: 'निष्पक्ष', meaning: 'निष्पक्ष'),
  GameAnswer(answer: 'अभियंता', meaning: 'अभियंता'),
  ...
  GameAnswer(answer: 'रूपक', meaning: 'उपमा'),
  GameAnswer(answer: 'सुप्त', meaning: 'सोया हुआ'),
  GameAnswer(answer: 'कमीज़', meaning: 'शर्ट'),
  GameAnswer(answer: 'गृहस्थ', meaning: 'गृहस्थ'),
  GameAnswer(answer: 'आधुनिक', meaning: 'नवीन'),
  GameAnswer(answer: 'ज्योतिष', meaning: 'खगोल'),
  GameAnswer(answer: 'अधिकार', meaning: 'अधिकार'),
  GameAnswer(answer: 'ब्रह्माण्ड', meaning: 'ब्रह्मांड'),
  GameAnswer(answer: 'अनुप्रास', meaning: 'अनुप्रास'),
  ...
  GameAnswer(answer: 'यथार्थ', meaning: 'वास्तविकता'),
  GameAnswer(answer: 'अवकाश', meaning: 'छुट्टी'),
  GameAnswer(answer: 'प्रवंचना', meaning: 'धोखा'),
];
